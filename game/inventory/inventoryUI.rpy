...
screen item_description(selling=False):
    frame xysize 1200, 56:
        ...
        if selected_item is not None:
            ...
            text thisitem[3] offset (14,6) color "#000000"
        elif selling:
...
screen inventory(collection, selling=False):
    ...
    hbox:
        ...
        spacing 4
        style_prefix "sort"
        textbutton _("SORT BY:") text_color "#000000"
                    ...
                    hbox xsize 260:
                        ...
                        if uses_gold and thisitem.value > 0:
                            hbox xsize 100:
                                xalign 1.0
                                yoffset 50
                                text _("Price:") color "#000000"
                                text " {}" .format(int(thisitem.value/2)) color "#000000"
...
screen invgrid(collection, page, first, last, selling=False):
    ...
    frame:
        ...
        text _("Page [page]") color "#000000" align (.96,.96)
